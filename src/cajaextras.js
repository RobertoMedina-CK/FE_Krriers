...
function Cajaextras() {
  ...
  const update = () => {
    ...
    Axios.put(`https://krriers.moveurads.com/caja`, bodyCarga)
      .then(() => {
        getCaja();
        limpiarCampos();
        Swal.fire({
  ...
  return (
    <div className="container">
      <div className="card text-center">
        <div className="card-header">CAJA KRRIERS SOLO COBRAS EXTRAS PEDIDOS CERRADOS</div>
        ...
        <div className="card-footer text-muted">
          <div>
            <button className="btn btn-outline-success m-2" onClick={generapdf}>
              Cobrar
            </button>
            <button
